    ...
    <div className="min-h-screen bg-[#0F172A] text-slate-100">
      ...
      <section className="pt-40 pb-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl font-extrabold leading-tight tracking-tight mb-6">
            Every asset,{" "}
            <span className="text-indigo-400">every department,</span>
            {" "}one platform.
          </h1>
          ...
          <p className="text-lg text-slate-400 leading-relaxed max-w-xl mx-auto mb-10">
            ...
            Strathmore&apos;s physical assets — with real-time updates,
            offline support, and full role-based access control.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-semibold text-indigo-400 uppercase 
                          tracking-widest mb-3">Features</p>
      ...
      <section className="py-24 px-6 bg-slate-900/30">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-semibold text-indigo-400 uppercase 
                          tracking-widest mb-3">Roles & Access</p>
            <h2 className="text-3xl font-bold tracking-tight">
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-lg mx-auto p-10 rounded-2xl bg-slate-900/60 
          ...
          <p className="text-sm text-slate-400 mb-8">
            Join Strathmore&apos;s asset management system and bring clarity 
            to every department.
          </p>
          <Link href="/signup"
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between 
          ...
          <div className="flex gap-4">
            ...
            <Link href="/signup" className="text-xs text-slate-500 hover:text-slate-300">
              Sign up
            </Link>
          </div>
        </div>
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Keep working when connectivity drops. Changes sync when you're back online.",
  },
  {
    icon: "📋",
...
const ROLES = [
  {
    name: "Asset Manager",
    color: "#6366F1",
    perms: ["Create departments", "Invite staff", "Full asset CRUD", "Assign roles"],
  },
  {
    name: "Maintenance Engineer",
    color: "#F59E0B",
    perms: ["Flag broken assets", "Log repairs", "Update status", "Audit assets"],
  },
  {
    name: "Support Staff",
    color: "#34D399",
  ...
  },
  {
    name: "SaaS Admin",
    color: "#F87171",
    perms: ["Full system access", "All departments", "Audit logs", "User management"],
  },
];